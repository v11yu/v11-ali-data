...
public class OutputToolImpl {
	...
	public void outputAllRecord(String filepath,List<Record> records){
		File file = new File(filepath);
		try {
			BufferedWriter w = new BufferedWriter(new FileWriter(file));
			w.write("user_id,item_id,behavior_type,user_geohash,item_category,time");
			w.newLine();
