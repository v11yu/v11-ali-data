...
/**
 * Generates code based on the provided arguments, which consist of classname of
 * a scheme and its options (outputs it to stdout). The generated code
 * instantiates the scheme and sets its options. The classname of the generated
 * code is <code>OptionsTest</code>.
 *
	...
	public static void main(String[] args) throws Exception {
		...
		if (scheme instanceof OptionHandler) {
			...
			buf.append("    scheme.setOptions(weka.core.Utils.splitOptions(\""
					+ Utils.backQuoteChars(Utils.joinOptions(handler
							.getOptions())) + "\"));\n");
			buf.append("  }\n");
		}
		buf.append("}\n");
